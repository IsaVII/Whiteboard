const { generateAnonymousName, generateRandomColor } = require('../../src/utils/nameGenerator');
...
describe('Name Generator Utility', () => {
  describe('generateAnonymousName', () => {
    ...
    test('should only use allowed adjectives and animals', () => {
      const ADJECTIVES = [
        'Anonymous', 'Curious', 'Sneaky', 'Happy', 'Sleepy',
        'Brave', 'Clever', 'Gentle', 'Jolly', 'Mighty',
        'Quiet', 'Swift', 'Witty', 'Zesty',
      ];
      const ANIMALS = [
        'Elephant', 'Otter', 'Fox', 'Panda', 'Falcon',
        'Koala', 'Tiger', 'Penguin', 'Dolphin', 'Badger',
        'Raccoon', 'Owl', 'Wolf', 'Lynx',
      ];
  ...
  describe('generateRandomColor', () => {
    test('should generate a valid Tailwind color class', () => {
      const VALID_COLORS = [
        'bg-yellow-400', 'bg-blue-400', 'bg-purple-400', 'bg-pink-400',
        'bg-green-400', 'bg-red-400', 'bg-indigo-400', 'bg-cyan-400',

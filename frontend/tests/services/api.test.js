...
describe('API Service', () => {
  ...
  describe('fetchBoard', () => {
    ...
    test('should throw error if fetch fails', async () => {
      ...
      await expect(fetchBoard('nonexistent')).rejects.toThrow('Failed to load board');
    });
  });
  ...
  describe('listBoards', () => {
    test('should fetch all boards successfully', async () => {
      ...
      expect(fetch).toHaveBeenCalledWith(expect.stringContaining('/api/boards'));
  ...
  describe('createNewBoard', () => {
    ...
    test('should throw error if creation fails', async () => {
      ...
      await expect(createNewBoard('existing-board')).rejects.toThrow('Failed to create board');
    });
  });
  ...
  describe('renameBoard', () => {
    ...
    test('should throw error if rename fails', async () => {
      ...
      await expect(renameBoard('nonexistent', 'new-name')).rejects.toThrow('Failed to rename board');
    });
  });
  ...
  describe('deleteBoard', () => {
    ...
    test('should throw error if deletion fails', async () => {
      ...
      await expect(deleteBoard('nonexistent')).rejects.toThrow('Failed to delete board');
    });
  });
});
